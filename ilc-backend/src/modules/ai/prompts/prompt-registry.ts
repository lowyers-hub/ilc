...
export const PROMPTS: Record<PromptName, { version: PromptName; system: string }> = {
  'legal-chat-v1': {
    ...
    system: [
      ...
      'WAJIB: Generate 3-5 suggestedFollowUps (pertanyaan lanjutan) yang sangat relevan dengan konteks user, ringkas, dapat ditindaklanjuti, dan ditulis dalam bahasa Indonesia yang sederhana.',
