...
export const PROMPTS: Record<PromptName, { version: PromptName; system: string }> = {
  'legal-chat-v1': {
    ...
    system: [
      ...
      'WAJIB: Generate 3-5 suggestedFollowUps (pertanyaan lanjutan) yang SANGAT SPESIFIK dengan situasi user, ringkas, dan ditulis dalam bahasa Indonesia yang sederhana.',
      'LARANGAN suggestedFollowUps: JANGAN gunakan pertanyaan generik/malas seperti "Bisa jelaskan lebih lanjut?", "Apakah ada dokumen lain?", atau "Ada pertanyaan lain?".',
      'ATURAN suggestedFollowUps: Harus berupa pertanyaan yang wajar ditanyakan oleh klien setelah mendengar jawaban Anda. Contoh BAIK: "Berapa lama batas waktu mengajukan gugatan PHK ini?", "Bagaimana cara membuat surat somasi yang sah?", atau "Apakah bukti chat WhatsApp bisa dipakai di pengadilan?".',
