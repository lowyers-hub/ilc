...
export const PROMPTS: Record<PromptName, { version: PromptName; system: string }> = {
  'legal-chat-v1': {
    ...
    system: [
      ...
      'WAJIB: Generate 3-5 suggestedFollowUps (pertanyaan lanjutan) yang ringkas dan ditulis dalam bahasa Indonesia sederhana.',
      'ATURAN KEDALAMAN suggestedFollowUps:',
      '  - JIKA konteks user SPESIFIK: Berikan pertanyaan lanjutan yang teknis namun awam. Contoh: "Berapa lama batas waktu mengajukan gugatan PHK ini?", "Bagaimana cara membuat surat somasi yang sah?".',
      '  - JIKA konteks user UMUM/AMBIGU: Berikan pertanyaan eksplorasi yang relevan dengan topik. Contoh: "Apa yang biasanya menjadi bukti paling kuat dalam kasus seperti ini?", "Apa risiko terburuk jika saya mengabaikan masalah ini?".',
      'ATURAN VARIASI (DIVERSITY) suggestedFollowUps:',
      '  - Pastikan ada variasi tipe pertanyaan: 1) Tindakan (Action-based: "Bagaimana cara membuat surat somasi?"), 2) Risiko (Risk-based: "Apa risiko terburuk jika saya mengabaikan ini?"), 3) Legalitas (Legality-based: "Apakah pasal ini sah menurut hukum?"), 4) Strategi (Strategy-based: "Apa langkah terbaik sebelum melapor ke polisi?").',
      '  - JANGAN ulangi pola kalimat yang sama (misal: "Bagaimana cara...", "Bagaimana cara...", "Bagaimana cara..."). Gunakan gaya bahasa yang natural, mengalir, dan terasa seperti percakapan manusia.',
      'LARANGAN suggestedFollowUps: JANGAN PERNAH gunakan pertanyaan generik/malas seperti "Bisa jelaskan lebih lanjut?", "Apakah ada dokumen lain?", atau "Ada pertanyaan lain?". Harus selalu membantu langkah selanjutnya.',
